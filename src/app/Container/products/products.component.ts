...
@Component({
  ...
  standalone: true,
  imports: [CommonModule,SingleproductComponent,FilterComponent],
...
export class ProductsComponent {
  ...
  totalNumberofCount:number=this.products.length;
  totalProductsInStock:number=this.products.filter(p => p.is_in_inventory === true).length;
  totalProductsOutofStock:number=this.products.filter(p => p.is_in_inventory === false).length;
